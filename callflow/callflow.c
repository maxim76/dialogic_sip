...
//---------------------------------------------------------------------------
void Log(int Src, int Line, char *msg, int Svrt) {
...
//---------------------------------------------------------------------------
void LogGC(int Line, int event, char *msg, int Svrt) {
...
//---------------------------------------------------------------------------
void LogDX(int Line, int event, char *msg, int Svrt) {
...
//---------------------------------------------------------------------------
void LogFunc(int Channel, char *FuncName, int ret) {
  char str[LOGSTRSIZE];
	...
	// Global Call Event
		...
		switch (evttype) {
			...
			case GCEV_OFFERED:
				...
				sprintf(str,"CgPN:[%s] CdPN:[%s]", ChannelInfo[index].CgPN, ChannelInfo[index].CdPN);
			...
			case GCEV_DROPCALL:
                                LogGC(index, evttype, "", 0);
				long state = ATDX_STATE(ChannelInfo[index].hdVoice);
